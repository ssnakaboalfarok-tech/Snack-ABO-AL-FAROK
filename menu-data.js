...
window.MENU = {
  ...
  items: [
    /* ---------- سندويشات: مقلي ---------- */
    { cat: "sandwiches", sub: "fried", name: "سندويش كريسبي", ingredients: "مايونيز - خس - مخلل - قطع كريسبي - كول سلو", price: 350, img: "/images/Gemini_Generated_Image_hotspbhotspbhots.webp" },
    ...
    /* ---------- سندويشات: مشوي ---------- */
    { cat: "sandwiches", sub: "grilled", name: "سندويش فرانشيسكو", ingredients: "مايونيز - مخلل - قطع دجاج مشوية - فطر - قشقوان - صوص الشيف - ذرة", price: 400, img: "/images/Gemini_Generated_Image_hotspbhotspbhots.webp" },
    ...
    /* ---------- سندويشات: لحمة ---------- */
    { cat: "sandwiches", sub: "meat", name: "سندويش برجر لحمة كلاسيك", ingredients: "مايونيز - مخلل - كول سلو - خس", price: 400, img: "/images/Gemini_Generated_Image_hotspbhotspbhots.webp" },
    ...
    { cat: "meals", sub: "single", sub2: "single-fried", name: "وجبة شخصية سوبريم", ingredients: " قطعتين سوبريم(روستو - ذرة) - كول سلو - بطاطا - مايونيز - سوسيرة كوكتيل - كتشب حلو - كتشب حد - خبزة  ", price: 650, img: "/images/Gemini_Generated_Image_hotspbhotspbhots.webp" },
